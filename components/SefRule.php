...
class SefRule extends UrlRule{
    ...
    public function createUrl($manager, $route, $params)
    {
        ...
        if($route == "site/advancedsearch"){
            if(isset($params["page"]))
                return "advancedsearch.html?game=".$params["game"].'&publisher='.
                $params["publisher"].'&genre='.
                $params["genre"].'&platform='.
                $params["platform"].'&price_from='.
                $params["price_from"].'&price_to='.
                $params["price_to"].'&order='.
                $params["order"]."&page=".$params["page"];
            else
                return 'advancedsearch.html?game=' . $params["game"] . '&publisher=' .
                $params["publisher"] . '&genre=' . $params["genre"] . '&platform=' .
                $params["platform"] . '&price_from=' .
                $params["price_from"] . '&price_to=' .
                $params["price_to"] . '&order=' .
                $params["order"];
